...
public class DongHoDem extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dong_ho_dem);
    ...
    private void setTimer() {
        ...
        if (!edtTimerValue.getText().toString().equals("")) {
            ...
            Toast.makeText(DongHoDem.this, "Please Enter Minutes...",
